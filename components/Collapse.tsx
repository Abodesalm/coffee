...
export default function Collapse({text, title}) {
  ...
  return (
    <div className="w-[90%] min-h-[75px] back flex flex-row justify-between items-center overflow-hidden pl-4">
      <div className="py-5 md:py-2 w-[100%] space-y-4">
        <h4 className="lg:text-[15px] md:text-[10px]">{title}</h4>
        {stat==true&&
          <div className="h-[fit-content] w-[90%] transition"><p className="font-normal text-[15px] lg:text-[11px] md:text-[10px]">{text}</p></div>
        }
      </div>
