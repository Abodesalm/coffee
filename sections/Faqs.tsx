...
export default function Faqs() {
  return (
    <div className="pad min-h-[500px] flex flex-col items-center gap-6 lg:mt-12 md:mt-16" id="faqs">
      <h2 className="lg:text-[34px] text-center">Common Customer Questions</h2>
